...
- [Kugeci](https://www.kugeci.com/) (Chinese lyrics; fuzzy-matches results since the site search is a plain substring match)
- [Lyricsify](https://www.lyricsify.com/) (uses `cloudscraper` to pass Cloudflare; may still fail when the site serves a managed/Turnstile challenge)
